...
console.log(1 + 2 + "2");         
console.log(1 + "2" + "2");
console.log(1 + 3 + "2" + "2");    // ****DISCLAIMER: WRITING SUCH CONFUSING CODE IS DISCOURAGED, USE OF PARENTHESIS IS PREFFERED.
...
console.log(+true);                 // DON'T DO SUCH NON-SENSES IN YOUR CODE 
console.log(+"");
